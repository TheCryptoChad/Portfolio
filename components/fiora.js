...
import { FioraContainer, FioraSpinner } from './fiora-loader'
...
const Fiora = () => {
  ...
  return <FioraContainer ref={refContainer}>{loading && <FioraSpinner />}</FioraContainer>
}
