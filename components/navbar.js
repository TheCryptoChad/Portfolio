    ...
    <Box position="fixed" as="nav" w="100%" bg={useColorModeValue('#ffffff40', '#20202380')} css={{ backdropFilter: 'blur(10px)' }} zIndex={1} {...props}>
      <Container display="flex" p={2} maxW="container.md" wrap="wrap" align="center" justify="space-between">
        ...
        <Stack direction={{ base: 'column', md: 'row' }} display={{ base: 'none', md: 'flex' }} width={{ base: 'full', md: 'auto' }} alignItems="center" flexGrow={1} mt={{ base: 4, nmd: 0 }}>
          ...
          <LinkItem target="_blank" href="https://github.com/TheCryptoChad/Portfolio" path={path} display="inline-flex" alignItems="center" style={{ gap: 4 }} pl={2}>
            Source
          </LinkItem>
        </Stack>
          ...
          <Box ml={2} display={{ base: 'inline-block', md: 'none' }}>
            <Menu>
              ...
              <MenuList>
                ...
                <MenuItem as={Link} href="https://github.com/TheCryptoChad/Portfolio">
                  View Source
                </MenuItem>
              </MenuList>
            </Menu>
